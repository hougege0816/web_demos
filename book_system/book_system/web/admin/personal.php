                ...
                <div id="user_info_box" class="col-md-6">
                    <div class="col-md-8 center-block">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-8">
                                <input type="text" id="message_name" class="aInput form-control">
                            </div>
                        </div>
                        <div class="form-group col-md-12">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-8">
                                <input type="text"  id="message_user_name" class="aInput form-control">
                            </div>
                        </div>
                        <div class="form-group col-md-12">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-8">
                                <select id="message_sex" class="aInput form-control">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-8">
                                <input type="text" id="message_phone" class="aInput form-control">
                            </div>
                        </div>
                        <div class="form-group col-md-12">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-8">
                                <input type="text" id="message_email" class=" aInput form-control">
                            </div>
                        </div>
                        <div class="form-group col-md-12">
                            <div class="col-md-3">
