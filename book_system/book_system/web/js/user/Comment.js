...
jQuery(function(){
    ...
    $(document).ready(function(){
        ...
        var url = '../../php/admin/Comment.php',
            userCommentUrl = '../../php/user/Comment.php',
        ...
        // 获取评论
        function getData(){
            bookSystem.getData(userCommentUrl,function(data){
        ...
        (function(){
            ...
            $('.query-btn').click(function(){
                ...
                bookSystem.query(userCommentUrl,data,function(data){
        ...
        (function(){
            ...
            $('.remove-comment-btn').click(function(){
                ...
                bookSystem.removeData(userCommentUrl,{aId:aId},function(data){
                    alert(data.content);
                    if (data.success){
                        getData();
                    }
